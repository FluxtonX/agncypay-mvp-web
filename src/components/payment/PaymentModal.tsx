...
import { ShieldCheck, Lock, CreditCard, ArrowRight, CheckCircle2, XCircle, RefreshCw, X, ChevronRight, HelpCircle, Landmark, Zap } from "lucide-react";
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      {/* Wire Transfer - Visible but Disabled (Rule 6) */}
                      <button
                        type="button"
                        disabled
                        className="p-3 rounded-xl border border-white/5 bg-white/[0.02] text-[#555] text-left cursor-not-allowed opacity-60 relative overflow-hidden"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-1.5 font-bold text-xs text-[#777]">
                            <Landmark className="h-3.5 w-3.5" /> Wire Transfer
                          </div>
                          <span className="text-[8px] font-extrabold uppercase px-1.5 py-0.5 rounded bg-white/10 text-[#aaa]">Disabled</span>
                        </div>
                        <span className="text-[9px] text-[#555] mt-1 block">Fedwire / SWIFT (Enterprise Only)</span>
                      </button>

                      {/* Real-Time Payments (RTP) - Visible but Disabled (Rule 6) */}
                      <button
                        type="button"
                        disabled
                        className="p-3 rounded-xl border border-white/5 bg-white/[0.02] text-[#555] text-left cursor-not-allowed opacity-60 relative overflow-hidden"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-1.5 font-bold text-xs text-[#777]">
                            <Zap className="h-3.5 w-3.5" /> Real-Time Payments (RTP)
                          </div>
                          <span className="text-[8px] font-extrabold uppercase px-1.5 py-0.5 rounded bg-white/10 text-[#aaa]">Disabled</span>
                        </div>
                        <span className="text-[9px] text-[#555] mt-1 block">Instant Clearing House Rail</span>
                      </button>
                    </div>
                  </div>
