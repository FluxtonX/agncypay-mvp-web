...
const INTEGRATIONS: IntegrationDef[] = [
  {
    ...
    textColor: "#ffffff",
    logoText: "QB",
    connectPath: "http://localhost:3001/api/v1/quickbooks/connect",
...
const invoiceSourceCopy: Record<string, InvoiceWorkspaceCopy> = {
  brand: {
...
const metricCardsByWorkspace: Record<string, MetricCard[]> = {
  brand: [
